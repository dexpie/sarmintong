        ...
        <section id="about" className="about-section scroll-effect">
            <div className="container text-center">
                ...
                <div className="about-image fade-in">
                    <img
                        src="https://i0.wp.com/finalweapon.net/wp-content/uploads/2023/08/Frieren-Beyond-Journeys-End-opening-and-ending-theme-songs.jpg?fit=1920%2C1080&ssl=1"
                        alt="Frieren from Beyond Journey's End"
